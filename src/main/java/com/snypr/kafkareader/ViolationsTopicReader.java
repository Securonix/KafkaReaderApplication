...
/**
 * This ViolationsTopicReader class reads data from Violations Topic, and store
 ...
 * @since 2018-05-19
 */
public class ViolationsTopicReader {
    ...
    /**
     * Entry point for Application.This reads data from Violations Topic.EEO
    ...
    public static void main(String args[]) throws Exception {
        ...
        //Violation Topic is configured to read data.
        kafkaConfigBean.setViolationTopic("alpha-Violations");
        ...
        final String groupId = "ViolationsTopicReader-" + UUID.randomUUID().toString();
        ...
        try {
            ...
            // Subscribe Violations Topic for data poll.
            consumer.subscribe(Arrays.asList(kafkaConfigBean.getViolationTopic()));

            // jsonList is used to store all JSON requests (fetched from Violation topic).
            List<String> jsonList = new ArrayList<>();

            // File initializations is done for writing data into confiured file.
            ...
            while (true) {
                ...
                if (records != null) {
                    ...
                    if (!jsonList.isEmpty()) {
                        ...
                        try {
                            fstream = new FileWriter("/Users/manishkumar/Documents/manish/code/tempFolder/vioalations.txt", true);
            ...
            LOGGER.error("Failed to read from Violations topic" + e);
        }
